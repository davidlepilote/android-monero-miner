...
[![TeamCity status](https://ci.smartnsoft.com/app/rest/builds/buildType(id:android_monero_miner)/statusIcon)](https://ci.smartnsoft.com/viewType.html?buildTypeId=android_monero_miner&tab=buildTypeStatusDiv)
